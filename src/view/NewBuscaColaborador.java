 ...
 * @author aluno
 */
public class NewBuscaColaborador extends javax.swing.JDialog {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaColaborador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
     ...
     */
     public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewBuscaColaborador dialog = new NewBuscaColaborador(new javax.swing.JFrame(), true);
