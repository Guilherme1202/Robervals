 ...
 * @author aluno
 */
public class NewBuscaCondPgto extends javax.swing.JDialog {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaCondPgto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("BUSCA CONDIÇÃO DE PAGAMENTO");
        ...
        jTableDadosAchados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Descrição", "Numero de Parcelas", "Dias P/Primeira Parcela"
            }
        ) {
     ...
     */
     public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewBuscaCondPgto dialog = new NewBuscaCondPgto(new javax.swing.JFrame(), true);
