 ...
 * @author aluno
 */
public class NewBuscaProduto extends javax.swing.JDialog {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDadosAchados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Descrição", "Marca", "Código de Barras", "Data de Cadastro", "Status"
            }
        ) {
     ...
     */
     public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewBuscaProduto dialog = new NewBuscaProduto(new javax.swing.JFrame(), true);
