 ...
 * @author aluno
 */
public class NewBuscaFornecedor extends javax.swing.JDialog {

    /**
     * Creates new form NewModelBuscar
     */
    public NewBuscaFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
     ...
     */
     public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewBuscaFornecedor dialog = new NewBuscaFornecedor(new javax.swing.JFrame(), true);
