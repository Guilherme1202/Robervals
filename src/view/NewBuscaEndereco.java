...
public class NewBuscaEndereco extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("BUSCA ENDEREÇO");
        ...
        if (jTableDadosAchados.getColumnModel().getColumnCount() > 0) {
            jTableDadosAchados.getColumnModel().getColumn(0).setResizable(false);
            jTableDadosAchados.getColumnModel().getColumn(1).setResizable(false);
            jTableDadosAchados.getColumnModel().getColumn(2).setResizable(false);
            jTableDadosAchados.getColumnModel().getColumn(3).setResizable(false);
        }
